...
namespace AddressbookNETFramework
{
    public class TestingPackageForContactsXml : BaseClass
    {
        ...
        public void XmlAddNewContactTest()
        {
            ...
            ContactData generateContacnt = app.Contacts.AddNewContactInFile("contacts.xml");
        ...
        {
            app.Contacts.PreAddContactInFile(0, "contacts.xml");
            ...
            ContactData generateContacnt = app.Contacts.EditFirstContactInFile(0, "ContactEditXml.xml");

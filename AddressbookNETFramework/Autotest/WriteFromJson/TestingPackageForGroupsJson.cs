...
namespace AddressbookNETFramework
{
    public class TestingPackageForGroupsJson : BaseClass
    {
        ...
        public void JsonCreateNewGroupTest()
        {
            ...
            GroupData generateData = app.Groups.CreateNewGroupInFile("groups.json");
        ...
        {
            app.Groups.PreAddGroupInFile(0, "groups.json");
            ...
            GroupData generateData = app.Groups.EditFirstGroupInFile(0, "GroupEditJson.json");

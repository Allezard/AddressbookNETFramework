...
namespace AddressbookNETFramework
{
    public class TestingPackageForContactsJson : BaseClass
    {
        ...
        public void JsonAddNewContactTest()
        {
            ...
            ContactData generateContacnt = app.Contacts.AddNewContactInFile("contacts.json");
        ...
        {
            app.Contacts.PreAddContactInFile(0, "ContactEditJson.json");
            ...
            ContactData generateContacnt = app.Contacts.EditFirstContactInFile(0, "ContactEditJson.json");
        ...
        public void JsonDeleteFirstContactTest()
        {
            ...
            app.Contacts.PreAddContactInFile(0, "contacts.json");
            //Создаем новый контакт, если его нет.
